...
# class ContractHasClient(models.Model): связь многие ко многим, таблица автоматом в джанго создаётся
...
class InternationalPassport(models.Model):
    ...
    class Meta:
        verbose_name = "Заграничный паспорт"
        verbose_name_plural = "Заграничные паспорта"
        # managed = False
...
class Position(models.Model):
    ...
    position = models.OneToOneField(Group, models.CASCADE, blank=True)
...
class StatusProcess(models.Model):
    ...
    class Meta:
        ...
        verbose_name_plural = "Статусы процессов"
        # managed = False
...
class Transport(models.Model):
    ...
    class Meta:
        verbose_name = "Траспорт"
        verbose_name_plural = "Траспорты"
        # managed = False
        # db_table = 'transport'
